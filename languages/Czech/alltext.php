...
//added in 14.0
$text['oneyear'] = "rok";
$text['pwdcodelink'] = "Po kliknutí na tento odkaz vám bude zasláno doèasné heslo";
$text['pwdcodesent'] = "Na va¹i emailovou adresu byl odeslán odkaz pro obnovení hesla.";
$text['moved'] = "Pøesunuto";
$text['citation'] = "Citace";
$text['other'] = "Jiné";
$text['death'] = "Úmrtí";
$text['burial'] = "Pohøeb";
$text['cremation'] = "Kremace";
$text['marriage'] = "Sòatek";
$text['divorce'] = "Rozvod";
$text['bylength'] = "Kroky";
$text['bymarriages'] = "Man¾elství";
$text['none'] = "®ádný";
