...
switch ( $textpart ) {
	...
	case "branches":
		...
		$admtext['branchdiscl'] = "Ta wartość reprezentuje sumaryczną liczbę łączy gałęzi,
niekoniecznie liczbę osób albo rodzin faktycznie powiązanych z tą gałęzią.
Jeśli ostatnio importowałeś Twoje dane, może być konieczne odświeżenie etykiet gałęzi.";
	...
	case "cemeteries":
		...
		$admtext['requiredmap'] = "Wymagane jeśli używasz mapy.<br/> Powinno odpowiadać nazwie i lokalizacji pliku w folderze <em>Nagrobków</em>, jeśli plik jest załadowany.
<br/>Na przykład: jeśli folder nagrobków nazwany jest <em>Nagrobki</em> i chcesz by plik
został nazwany <em>mapa.jpg</em>
<br/>i został wprowadzony do podfoldera nagrobków nazwanego <em>mymaps</em>,
<br/> wpisz w tym polu <em>mymaps/mapa.jpg</em>.";
		//added in 8.0.0
	...
	case "gedimport":
		...
		$admtext['imphints'] = "Wskazówki: <q>Wszystkie dane</q> oznacza wszystkie osoby, rodziny, źródła i przypisy
(łącza do mediów nie zginą póki ich ID pozostają bez zmian). <q>Pasujący zapis</q> oznacza zgodność ID; dopisywane są wówczas tylko nowe informacje.
<q>Dołączanie</q> importuje wszystkie dane nadając nowe IDs.";
	...
	case "photos":
		...
		$admtext['requiredhs'] = "Wymagane. Musi być zgodne ze ścieżką i nazwą pliku w folderze <em>Zdjęcia</em>.
Jeżeli np. folder zdjęć nazywa się <em>Zdjęcia</em> a plik <em>mojezdjecie.jpg</em> ma zostać zapisany w folderze
podrzędnym nazwanym <em>NoweZdjecia</em>, wpisz w tym polu <em>NoweZdjecia/mojezdjecie.jpg</em>.";
		...
		$admtext['mapinstr3'] = "Aby połączyć obszar tego zdjęcia z osobą, najpierw wybierz drzewo osoby, a następnie utwórz prostokąt dla żądanego regionu. Można to zrobić klikając w lewym górnym rogu regionu i przeciągając do 
	...
	case "setup":
		...
		$admtext['cfgrw'] = "Wszystkie foldery konfiguracyjne są ustawione jako R/W";
		...
		$admtext['maxnoteprev'] = "Maksymalna liczba znaków w liście";
		...
		$admtext['showshare'] = "Pokaż linki do Facebooka i in.";
		...
		$admtext['backupnote'] = "UWAGA: Jeśli baza danych jest bardzo duża, warto skorzystać ze specjalistycznego narzędzia (jak mysqldump lub phpMyAdmin) do tworzenia kopii zapasowych i przywracania tabel. Co najmniej jedno z nich jest zwykle dostępne z panelu sterowania.";
        ...
        $admtext['assumeliving'] = "Załóż że żyjący, jeśli nie jest zmarły do wieku";
...
$admtext['lds'] = "LDS";
$admtext['norights'] = "Wymagana autoryzacja. Podaj nazwę użytkownika oraz hasło i zaloguj się.";
